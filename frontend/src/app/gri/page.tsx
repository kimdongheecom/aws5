...
export default function GRIPage() {
  ...
  const requirements = {
    ...
    '2-1': [
      { id: '2-1-a', question: 'a. 법적 명칭 보고해주세요.' },
      { id: '2-1-b', question: 'b. 소유권 및 법인 구분 보고해주세요.' },
      { id: '2-1-c', question: 'c. 본사 위치 보고해주세요.' },
      { id: '2-1-d', question: 'd. 운영 국가(들) 보고해주세요.' }
    ],
    '2-2': [
      { id: '2-2-a', question: 'a. 지속 가능성 보고에 포함된 모든 엔티티 나열해주세요.' },
      { id: '2-2-b', question: 'b. 조직이 공개 기록에 제출된 연결 재무제표 또는 재무 정보를 감사한 경우, 재무 보고에 포함된 기업 목록과 지속 가능성 보고에 포함된 목록 간의 차이점을 명시해주세요.' },
      { id: '2-2-c', question: 'c. 조직이 여러 엔터티로 구성된 경우, 정보 통합에 사용된 접근 방식을 설명해주세요.\n\ni. 접근법이 소수의 이익을 위한 정보 조정을 포함하는지 여부\n\nii. 접근법이 법인 또는 법인의 일부에 대한 합병, 인수 및 처분을 고려하는 방법\n\niii. 접근 방식이 이 표준의 공개와 중요한 주제에 따라 다른지 그 여부와 방법' }
    ],
    '2-3': [
      { id: '2-3-a', question: 'a. 지속 가능성 보고의 보고 기간 및 빈도를 지정해주세요.' },
      { id: '2-3-b', question: 'b. 재무 보고의 보고 기간을 지정하고 지속 가능성 보고 기간과 일치하지 않는 경우 그 이유를 설명해주세요.' },
      { id: '2-3-c', question: 'c. 보고서 또는 보고된 정보의 발행일을 보고해주세요.' },
      { id: '2-3-d', question: 'd. 보고서 또는 보고서 내용에 대한 문의처를 명시해주세요.' }
    ],
    '2-4': [
      { id: '2-4-a', question: 'a. 이전 보고 기간에 작성된 정보의 재작성을 보고하고 설명해주세요.\n\ni. 재작성의 이유\n\nii. 재작성의 효과' }
    ],
    '2-5': [
      { id: '2-5-a', question: 'a. 최고 거버넌스 기구 및 고위 경영진의 참여 여부와 방법을 포함하여 외부 보증을 추구하기 위한 정책 및 관행을 설명해주세요.' },
      { id: '2-5-b', question: 'b. 조직의 지속가능성 보고가 외부적으로 검증된 경우 다음을 포함해주세요.\n\ni. 외부 검증 보고서 또는 검증에 대한 링크 또는 참조를 제공\n\nii. 사용된 보증 표준, 획득한 보증 수준 및 보증 프로세스의 제한 사항을 포함하여 무엇을 보증하고 어떤 기반으로 했는지 설명\n\niii. 조직과 보증 공급자 간의 관계를 설명' }
    ],
    '2-6': [
      { id: '2-6-a', question: 'a. 활동 중인 산업 영역을 보고해주세요.' },
      { id: '2-6-b', question: 'b. 가치 사슬을 다음을 포함하여 설명해주세요.\n\ni. 조직의 활동, 제품, 서비스 및 시장\n\nii. 조직의 공급망\n\niii. 조직 및 해당 활동의 다운스트림 엔티티' },
      { id: '2-6-c', question: 'c. 기타 관련 비즈니스 관계를 보고해주세요.' },
      { id: '2-6-d', question: 'd. 이전의 보고 기간과 비교하여 중요한 변경 사항을 설명해주세요.' }
    ],
    '2-7': [
      { id: '2-7-a', question: 'a. 총 직원 수와 이 합계를 성별 및 지역별 내역으로 나누어 보고해주세요.' },
      { id: '2-7-b', question: 'b. 정규직, 비정규직, 시간제 직원 등의 총 수를 다음으로 분류해 보고해주세요.\n\ni. 정규직, 성별 및 지역별 분류\n\nii. 비정규직, 성별 및 지역별 분류\n\niii. 영시간 계약자, 성별 및 지역별 분류\n\niv. 계약직 직원, 성별 및 지역별 분류\n\nv. 시간제 직원 및 성별 및 지역별 분류' },
      { id: '2-7-c', question: 'c. 데이터를 수집하는 데 사용되는 방법론 및 가정을 다음을 포함하여 설명해주세요.\n\ni. 인원수, FTE(Full-Time Equivalent) 또는 다른 방법론 사용\n\nii. 보고 기간 말에 보고 기간 전체의 평균, 또는 다른 방법론 사용' },
      { id: '2-7-d', question: 'd. 보고한 데이터를 이해하는 데 필요한 배경 정보를 함께 제공해주세요.' },
      { id: '2-7-e', question: 'e. 보고 기간 동안 직원 수의 중요한 변동을 설명해주세요.' }
    ],
    '2-8': [
      { id: '2-8-a', question: 'a. 피고용인이 아니고 조직에서 작업을 통제하는 총 근로자 수를 다음을 포함하여 보고해주세요.\n\ni. 가장 일반적인 근로자 유형 및 조직과의 계약 관계\n\nii. 그들이 수행하는 작업 유형' },
      { id: '2-8-b', question: 'b. 직원이 아닌 근로자의 수가 보고되는 데이터 수집 방법론 및 가정을 다음을 포함하여 설명해주세요.\n\ni. 인원수, FTE(Full-Time Equivalent) 또는 다른 방법론 사용\n\nii. 보고 기간 말에 보고 기간 전체의 평균 또는 다른 방법론 사용' },
      { id: '2-8-c', question: 'c. 보고 기간 동안 직원이 아닌 근로자 수의 주요한 변동을 설명해주세요.' }
    ],
    '2-9': [
      { id: '2-9-a', question: 'a. 최고 거버넌스 기구의 위원회를 포함한 거버넌스 구조를 설명해주세요.' },
      { id: '2-9-b', question: 'b. 경제, 환경 및 사람에 대한 조직의 영향 관리를 감독하고 의사 결정을 담당하는 최고 거버넌스 기구의 위원회를 나열해주세요.' },
      { id: '2-9-c', question: 'c. 최고 거버넌스 기구와 그 위원회의 구성을 다음을 포함하여 설명해주세요.\n\ni. 임원 및 비상임 회원\n\nii. 독립성\n\niii. 거버넌스 기구 구성원의 임기\n\niv. 각 구성원이 보유한 다른 중요한 직위 및 공약의 수와 공약의 성격\n\nv. 성별\n\nvi. 과소 대표 사회 집단\n\nvii. 조직의 영향과 관련된 역량\n\nviii. 이해관계자 대표' }
    ],
    '2-10': [
      { id: '2-10-a', question: 'a. 최고 거버넌스 기구와 그 위원회의 지명 및 선정 과정을 설명해주세요.' },
      { id: '2-10-b', question: 'b. 최고 거버넌스 기구 구성원을 지명하고 선정하는 데 사용되는 기준을 다음을 포함하여 설명해주세요.\n\ni. 이해관계자(주주 포함)의 견해\n\nii. 다양성\n\niii. 독립성\n\niv. 조직의 영향과 관련된 역량' }
    ],
    '2-11': [
      { id: '2-11-a', question: 'a. 최고 거버넌스 기구의 의장이 조직의 고위 임원이기도 한 지 여부를 기술해주세요.' },
      { id: '2-11-b', question: 'b. 의장이 고위 임원이기도 한 경우, 이해 상충을 예방하고 완화하는 방법을 설명해주세요.' }
    ],
    '2-12': [
      { id: '2-12-a', question: 'a. 지속 가능한 개발과 관련된 조직의 목적, 가치 또는 임무 진술, 전략, 정책 및 목표를 개발, 승인 및 업데이트하는 최고 거버넌스 기구와 고위 임원의 역할을 설명해주세요.' },
      { id: '2-12-b', question: 'b. 조직의 실사 및 경제, 환경 및 사람에 대한 조직의 영향을 식별하고 관리하기 위한 기타 프로세스를 감독하는 최고 거버넌스 기구의 역할을 다음을 포함하여 설명해주세요.\n\ni. 최고 거버넌스 기구가 이해관계자와 협력하여 이러한 프로세스를 지원하는지 여부 및 방법\n\nii. 최고 거버넌스 기구가 이러한 프로세스의 결과를 고려하는 방법' },
      { id: '2-12-c', question: 'c. 조직 프로세스의 효율성을 검토하는 데 있어 최고 거버넌스 기구의 역할을 설명해주세요.' }
    ],
    '2-13': [
      { id: '2-13-a', question: 'a. 최고 거버넌스 기구가 경제, 환경 및 사람들에 대한 조직의 영향을 관리하는 책임을 다음을 포함하여 위임하는 방법을 설명해주세요.\n\ni. 영향 관리 책임이 있는 고위 임원을 임명했는지 여부\n\nii. 영향 관리 책임을 다른 직원에게 위임했는지 여부' },
      { id: '2-13-b', question: 'b. 고위 임원 또는 기타 직원이 조직이 경제, 환경 및 사람에 미치는 영향의 관리에 대해 최고 거버넌스 기구에 보고하는 과정과 빈도를 기술해주세요.' }
    ],
    '2-14': [
      { id: '2-14-a', question: 'a. 최고 거버넌스 기구가 조직의 중요한 주제를 포함하여 보고된 정보를 검토하고 승인할 책임이 있는지 여부를 보고해주세요.' },
      { id: '2-14-b', question: 'b. 최고 거버넌스 기구가 검토하고 승인할 책임이 없는 경우, 그 이유를 설명해주세요.' }
    ],
    '2-15': [
      { id: '2-15-a', question: 'a. 이해 상충을 방지하고 완화하기 위한 최고 거버넌스 기구의 프로세스를 다음을 포함하여 설명해주세요.\n\ni. 크로스보드 멤버십\n\nii. 공급자 및 기타 이해관계자와의 상호출자\n\niii. 지배주주의 존재\n\niv. 특수관계자, 그 관계, 거래 및 미지급잔액' },
      { id: '2-15-b', question: 'b. 이해충돌이 이해관계자에게 공개되는지 여부를 기술해주세요.' }
    ],
    '2-16': [
      { id: '2-16-a', question: 'a. 중대한 사안이 최고 의사결정기구에 어떻게 전달되는지를 설명해주세요.' },
      { id: '2-16-b', question: 'b. 보고 기간 동안 최고 의사결정기구에 전달된 중대한 사안의 총 건수와 내용을 보고해주세요.' }
    ],
    '2-17': [
      { id: '2-17-a', question: 'a. 지속 가능한 개발에 대한 최고 거버넌스 기구의 집단적 지식, 기술 및 경험을 향상시키기 위해 취한 조치를 보고해주세요.' }
    ],
    '2-18': [
      { id: '2-18-a', question: 'a. 최고 거버넌스 기구의 성과를 평가하는 프로세스를 설명해주세요.' },
      { id: '2-18-b', question: 'b. 평가의 독립성 여부 및 평가 빈도를 보고해주세요.' },
      { id: '2-18-c', question: 'c. 평가에 대응하여 취한 조치를 설명해주세요.' }
    ],
    '2-19': [
      { id: '2-19-a', question: 'a. 최고 거버넌스 기구의 구성원과 고위 임원에 대한 보수 정책을 다음을 포함하여 설명해주세요.\n\ni. 고정급 및 변동급\n\nii. 사인온 보너스 또는 채용 장려금 지급\n\niii. 해지 지급\n\niv. 클로백\n\nv. 퇴직급여' },
      { id: '2-19-b', question: 'b. 보수 정책이 경제, 환경 및 국민에 대한 조직의 영향 관리와 어떻게 관련이 있는지 기술해주세요.' }
    ],
    '2-20': [
      { id: '2-20-a', question: 'a. 보수 정책을 설계하고 보수를 결정하는 프로세스를 다음을 포함하여 설명해주세요.\n\ni. 독립적인 최고 거버넌스 기구 위원 또는 독립적인 보수 위원회가 보수 결정 과정을 감독하는지 여부\n\nii. 보수에 관한 이해관계자(주주 포함)의 견해를 어떻게 추구하고 고려하는지\n\niii. 보수 컨설턴트가 보수를 결정하는 데 관여하는지 여부 및 만약 그렇다면 조직, 최고 거버넌스 기구 및 고위 임원으로부터 독립적인지 여부' },
      { id: '2-20-b', question: 'b. 해당되는 경우 보수 정책 및 제안에 대한 이해관계자의 투표 결과를 보고해주세요.' }
    ],
    '2-21': [
      { id: '2-21-a', question: 'a. 조직의 최고 연봉자에 대한 연간 총 보상액이 전체 직원에 대한 중간 연봉자에 대한 비율을 보고해주세요.' },
      { id: '2-21-b', question: 'b. 조직의 최고 연봉자에 대한 연간 총 보상액 증가율과 전체 직원에 대한 연간 총 보상액 증가율의 중간값 비율을 보고해주세요.' },
      { id: '2-21-c', question: 'c. 데이터를 이해하는 데 필요한 상황 정보와 데이터가 어떻게 작성되었는지 보고해주세요.' }
    ],
    '2-22': [
      { id: '2-22-a', question: 'a. 조직에 대한 지속 가능한 개발의 관련성과 지속 가능한개발에 기여하기 위한 전략에 대한 최고 거버넌스 기구 또는 조직의 가장 고위 임원의 성명서를 보고해주세요.' }
    ],
    '2-23': [
      { id: '2-23-a', question: 'a. 책임 있는 비즈니스 행위에 대한 정책 공약을 다음을 포함하여 설명해주세요.\n\ni. 공약이 참조하는 정부 간 권위 있는 수단\n\nii. 공약이 실사 수행을 규정하는지 여부\n\niii. 공약이 예방 원칙의 적용을 규정하는지 여부\n\niv. 공약이 인권 존중을 규정하는지 여부' },
      { id: '2-23-b', question: 'b. 인권을 존중하기 위한 구체적인 정책 공약을 다음을 포함하여 설명해주세요.\n\ni. 공약이 다루는 국제적으로 인정된 인권; 조직이 공약에서 특히 주의를 기울이는 위험에 처한 그룹 또는 취약한 그룹을 포함한 이해관계자의 범주' },
      { id: '2-23-c', question: 'c. 공개적으로 이용 가능한 경우 정책 공약에 대한 링크를 제공하거나, 정책 공약이 공개적으로 이용 가능하지 않은 경우, 그 이유를 설명해주세요.' },
      { id: '2-23-d', question: 'd. 각 정책 공약이 조직 내에서 승인된 수준을 보고해주세요.' },
      { id: '2-23-e', question: 'e. 정책 공약이 조직의 활동과 비즈니스 관계에 적용되는 범위를 보고해주세요.' },
      { id: '2-23-f', question: 'f. 정책 공약이 근로자, 비즈니스 파트너 및 기타 관련 당사자에게 어떻게 전달되는지 설명해주세요.' }
    ],
    '2-24': [
      { id: '2-24-a', question: 'a. 활동 및 비즈니스 관계 전반에 걸쳐 책임 있는 비즈니스 수행을 위한 각 정책 공약을 다음을 포함하는 방법을 설명해주세요.\n\ni. 조직 내 다양한 수준에 걸쳐 공약을 이행하기 위해 책임을 할당하는 방법\n\nii. 조직 전략, 운영 정책 및 운영 절차에 대한 공약을 통합하는 방법\n\niii. 비즈니스 관계를 통해 공약을 이행하는 방법\n\niv. 조직이 공약 이행에 대해 제공하는 교육' }
    ],
    '2-25': [
      { id: '2-25-a', question: 'a. 조직이 야기하거나 기여한 것으로 확인된 부정적 영향의 시정을 제공하거나 협력하기 위한 공약을 설명해주세요.' },
      { id: '2-25-b', question: 'b. 고충을 식별하고 해결하기 위한 접근방식을 설명해주세요.' },
      { id: '2-25-c', question: 'c. 부정적 영향의 교정조치를 제공하거나 협력하는 기타 프로세스를 설명해주세요.' },
      { id: '2-25-d', question: 'd. 고충처리 메커니즘의 의도된 사용자인 이해관계자가 이러한 메커니즘의 설계, 검토, 운영 및 개선에 어떻게 관여하는지 설명해주세요.' },
      { id: '2-25-e', question: 'e. 조직이 고충처리 메커니즘 및 기타 교정조치 프로세스의 효과를 추적하는 방법을 설명해주세요.' }
    ],
    '2-26': [
    ...
    // GRI 205 Anti-corruption
    '205-1': [
      { id: '205-1-a', question: 'a. 부패 관련 리스크 평가가 이뤄진 사업장 총 수와 비율을 보고해주세요.' },
      { id: '205-1-b', question: 'b. 부패 리스크 평가에서 확인된 중대한 리스크를 보고해주세요.' }
    ],
    '205-2': [
      { id: '205-2-a', question: 'a. 조직의 반부패 정책과 절차에 관해 커뮤니케이션을 완료한 지배구조 기구 구성원의 총 수와 비율 (지역별로 분석)을 보고해주세요.' },
      { id: '205-2-b', question: 'b. 조직의 반부패 정책과 절차에 관해 커뮤니케이션을 완료한 직원 총 수와 비율 (직원 카테고리별 그리고 지역별로 분석)을 보고해주세요.' },
      { id: '205-2-c', question: 'c. 조직의 반부패 정책과 절차에 관해 커뮤니케이션을 완료한 비즈니스 파트너 총 수와 비율 (비즈니스 파트너 유형별 그리고 지역별로 분석). 해당 반부패 정책과 절차에 대해 다른 사람이나 조직에게 커뮤니케이션을 완료한 경우에는 그에 대한 설명해주세요.' },
      { id: '205-2-d', question: 'd. 반부패 연수를 받은 지배구조 기구 구성원의 총 수와 비율 (지역별로 분석)을 보고해주세요.' },
      { id: '205-2-e', question: 'e. 반부패 연수를 받은 직원 총 수와 비율 (직원 카테고리별 그리고 지역별로 분석)을 보고해주세요.' }
    ],
    '205-3': [
      { id: '205-3-a', question: 'a. 확인된 부패 사건의 총 수와 특징을 보고해주세요.' },
      { id: '205-3-b', question: 'b. 부패 관련 직원이 해고되거나 징계받은 사건 총 수를 보고해주세요.' },
      { id: '205-3-c', question: 'c. 부패로 인해 비즈니스 파트너와의 계약이 종료되거나 계약 갱신이 취소된 사건 총 수를 보고해주세요.' },
      { id: '205-3-d', question: 'd. 보고기간 동안 부패 관련하여 조직 또는 조직의 직원을 대상으로 제기된 소송과 소송 결과를 보고해주세요.' }
    ],

    // GRI 206 Anti-competitive Behavior
    '206-1': [
      { id: '206-1-a', question: 'a. 보고기간 동안 경쟁저해 및 독과점금지 위반 관련하여 계류 중이거나 완료된 소송 건수를 보고해주세요.' },
      { id: '206-1-b', question: 'b. 완료된 소송의 주요 결과 (판결내용 포함)를 보고해주세요.' }
    ],

    // GRI 207 Tax
    '207-1': [
      { id: '207-1-a', question: 'a. 조세 접근방법을 다음과 같이 보고해주세요.\n\ni. 조세 전략 유무 및 공개적 사용 가능 시 전략에 대한 링크\n\nii. 조세 전략을 공식 승인·검토하는 거버넌스 또는 임원과 검토의 빈도\n\niii. 조세 규제 접근방법\n\niv. 조세 접근방법과 조직의 경영 전략 및 지속 가능한 개발 전략과의 연관성' }
    ],

    // GRI 301 Materials
    '301-1': [
      { id: '301-1-a', question: 'a. 보고기간 동안 조직의 주요 제품이나 서비스를 생산하거나 포장하는데 사용된 원재료의 총 중량 또는 용량을 재생 불가 원재료와 재생 가능 원재료로 구분하여 보고해주세요.' }
    ],
    '301-2': [
      { id: '301-2-a', question: 'a. 조직의 주요 제품과 서비스를 생산하는데 사용된 재생 투입 원재료의 비율을 보고해주세요.' }
    ],
    '301-3': [
      { id: '301-3-a', question: 'a. 각 제품 카테고리별로 재생된 제품과 포장재 비율을 보고해주세요.' },
      { id: '301-3-b', question: 'b. 해당 정보 공시를 위해 데이터를 수집한 방법을 보고해주세요.' }
    ],

    // GRI 302 Energy
    '302-1': [
      { id: '302-1-a', question: 'a. 비재생에너지원에서 나온 연료 총 소비량 (줄 (joules) 단위 또는 배수 (multiple)로 표시, 사용된 연료 유형 포함)을 보고해주세요.' },
      { id: '302-1-b', question: 'b. 재생에너지원에서 나온 연료 총 소비량 (줄 (joules) 단위 또는 배수 (multiple)로 표시, 사용된 연료 유형 포함)을 보고해주세요.' },
      { id: '302-1-c', question: 'c. 단위별 총 에너지 소비량을 다음과 같이 보고해주세요.\n\ni. 전력 소비량\n\nii. 난방 소비량\n\niii. 냉방 소비량\n\niv. 증기 소비량' },
      { id: '302-1-d', question: 'd. 단위별 총 에너지 판매량을 다음과 같이 보고해주세요.\n\ni. 전력 판매량\n\nii. 난방 판매량\n\niii. 냉방 판매량\n\niv. 증기 판매량' },
      { id: '302-1-e', question: 'e. 조직 내 총 에너지 소비량 (줄 (joules) 단위 또는 배수 (multiple)로 표시)을 보고해주세요.' },
      { id: '302-1-f', question: 'f. 사용된 표준, 방법, 가정, 측정 도구를 보고해주세요.' },
      { id: '302-1-g', question: 'g. 사용된 변환계수의 출처를 보고해주세요.' }
    ],
    '302-2': [
      { id: '302-2-a', question: 'a. 조직 외부에서의 에너지 소비량을 보고해주세요.' },
      { id: '302-2-b', question: 'b. 사용된 표준, 방법, 가정, 측정 도구를 보고해주세요.' },
      { id: '302-2-c', question: 'c. 사용된 변환계수의 출처를 보고해주세요.' }
    ],
    '302-3': [
      { id: '302-3-a', question: 'a. 조직의 에너지 집약도 비율을 보고해주세요.' },
      { id: '302-3-b', question: 'b. 에너지 집약도 측정을 위해 선택한 측정 항목(분모)을 보고해주세요.' },
      { id: '302-3-c', question: 'c. 에너지 집약도 측정에 포함된 에너지 종류를 보고해주세요.' },
      { id: '302-3-d', question: 'd. 에너지 집약도 계산에 사용되는 에너지 소비량이 조직 내부인지 외부인지 둘다 인지 여부를 기술해주세요.' }
    ],
    '302-4': [
      { id: '302-4-a', question: 'a. 에너지 절약과 효율적 사용을 통해 감축된 에너지 소비량을 보고해주세요.' },
      { id: '302-4-b', question: 'b. 감축된 에너지의 종류를 보고해주세요.' },
      { id: '302-4-c', question: 'c. 에너지 소비 감소량 계산에 사용된 기준을 보고해주세요.' },
      { id: '302-4-d', question: 'd. 사용된 표준, 방법, 가정, 측정 도구 등을 보고해주세요.' }
    ],
    '302-5': [
      { id: '302-5-a', question: 'a. 보고기간 동안 판매된 제품과 서비스의 감축된 에너지 필요량을 보고해주세요.' },
      { id: '302-5-b', question: 'b. 에너지 소비 감소량 계산에 사용된 기준을 보고해주세요.' },
      { id: '302-5-c', question: 'c. 사용된 표준, 방법, 가정, 측정 도구 등을 보고해주세요.' }
    ],
    ...
    '308-2': [
      ...
      { id: '308-2-e', question: 'e. 실제적, 잠재적으로 중대한 부정적 환경 영향을 미치는 것으로 확인되고 이러한 평가결과에 따라 계약관계가 종료된 공급업체 비율 (사유 포함)을 보고해주세요.' }
    ],
  ...
  const handleGenerateGRI = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setGriData('GRI 서비스에 연결할 수 없습니다. 서비스가 실행 중인지 확인해주세요.');
      }
    } catch (error) {
      console.error('GRI 생성 오류:', error);
      setGriData('GRI 생성 중 오류가 발생했습니다.');
    } finally {
      setLoading(false);
    }
  };
